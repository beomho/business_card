...
const RotationElement = () => {
  ...
  const onMouseMove = (event) => {
    ...
    if (primaryMouseButtonDown) {
      ...
      console.log("insideRotate : " + insideRotate);
      if (insideRotate) {
  ...
  return (
    <section>
      <div
        className="flex justify-center items-center bg-[url(/assets/bg.webp)] py-20"
        onMouseMove={onMouseMove}
      >
        <div
          className="rotation-div border-dashed border-4 border-gray-900 relative"
          style={{ rotate: `${rotation}deg` }}
        >
          <div className="select-none" draggable={false} ref={imgRef} />

          <div
            className="rotation-point bg-white shadow-lg p-2 absolute left-0 bottom-0 -translate-x-1/2 translate-y-1/2 rounded-full"
            ref={rotateBtnRef}
          >
            <MdSync />
          </div>
...
export default RotationElement;
